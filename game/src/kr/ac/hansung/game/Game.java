...
public class Game extends Canvas implements Runnable {
    ...
    public static final Dimension DIMENSIONS = new Dimension(WIDTH * SCALE, HEIGHT * SCALE);//720*540
    public static Game game;

    private int randomX = (int)(Math.random() * 200);
    private int randomY = (int)(Math.random() * 200);
    ...
    public ChatClient socketChatClient;
    ...
    public void init() {
        ...
        player = new PlayerMP(level, randomX, randomY, input, JOptionPane.showInputDialog(this, "Please enter a username"),
                null, -1);
    ...
    public synchronized void start() {
        ...
        if (!isApplet) {
            if (JOptionPane.showConfirmDialog(this, "Do you want to run the server") == 0) {
                ...
                //chatserver start
                socketChatServer = new ChatServer(this);
                socketChatServer.start();
            }
